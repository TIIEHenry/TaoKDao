...
public class CppLanguage extends LanguageCFamily {
    private static class SingletonInner {
        private static CppLanguage language = new CppLanguage();
    }
...
//        setOperators(BASIC_C_OPERATORS);
        ...
        setInternalFuncs(cFunctions);//先setName才能addName
        addInternalFunc(preDefineField);
        addInternalFunc(cppNamespace);
        addInternalFunc(cppClasses);
        addInternalFunc(cppFunctions);
        addInternalFunc(extraWord);
    }
    @Override

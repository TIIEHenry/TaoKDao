...
public class infParser extends Parser {
	...
	public static class InfContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof infVisitor ) return ((infVisitor<? extends T>)visitor).visitInf(this);
	...
	public static class SectionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof infVisitor ) return ((infVisitor<? extends T>)visitor).visitSection(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SectionheaderContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof infVisitor ) return ((infVisitor<? extends T>)visitor).visitSectionheader(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StringContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof infVisitor ) return ((infVisitor<? extends T>)visitor).visitString(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class LineContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof infVisitor ) return ((infVisitor<? extends T>)visitor).visitLine(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StringlistContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof infVisitor ) return ((infVisitor<? extends T>)visitor).visitStringlist(this);
			else return visitor.visitChildren(this);
		}
	}

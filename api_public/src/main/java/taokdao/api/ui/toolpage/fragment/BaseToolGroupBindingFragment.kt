...
abstract class BaseToolGroupBindingFragment<VB : ViewBinding, C>(prop: IPanelProp) : BaseToolGroupFragment<C>(
    ...
    private fun resolveBindingClass(): Class<VB> {
        ...
        while (currentClass != Any::class.java) {
            ...
            if (genericSuper is ParameterizedType) {
                ...
                if (rawClass == BaseToolGroupBindingFragment::class.java) {

    ...
    private static void showWarningDialog(final Context context) {
        ...
        handler.post(() -> {
            ...
            Dialogs.global
                    ...
                    .content(Html.fromHtml("Can't access system logs"))
                    .positiveText()
                    .neutralText(R.string.copy_text)
                    .onPositive(dialog -> dialog.dismiss())
                    .onNeutral(dialog -> {
...
//                    log.e(e, "cannot kill process " + pid);
    ...
    public static void requestRoot(final Context context) {
        ...
        Handler handler = new Handler(Looper.getMainLooper());
        Runnable toastRunnable = () -> Toast.makeText(context, "Logcat need root permission!", Toast.LENGTH_LONG).show();

...
import taokdao.main.business.plugin.plugin_manage.launcher.flowtag.adapter.DefaultFlowTagAdapter;
...
public class FlowTagLayout extends ViewGroup {
     ...
     */
    FlowTagLayout.OnTagClickListener mOnTagClickListener;

    /**
     * the tag select event callback
     */
    FlowTagLayout.OnTagSelectListener mOnTagSelectListener;
    ...
    public FlowTagLayout setAdapter(BaseTagAdapter adapter) {
        ...
        if (mAdapter != null) {
            mDataSetObserver = new FlowTagLayout.AdapterDataSetObserver();
    ...
    private void reloadData() {
        ...
        for (int i = 0; i < mAdapter.getCount(); i++) {
            ...
            if (mAdapter instanceof FlowTagLayout.OnInitSelectedPosition) {
    ...
    public FlowTagLayout setOnTagClickListener(FlowTagLayout.OnTagClickListener onTagClickListener) {
        mOnTagClickListener = onTagClickListener;
        return this;
    }

    public FlowTagLayout setOnTagSelectListener(FlowTagLayout.OnTagSelectListener onTagSelectListener) {

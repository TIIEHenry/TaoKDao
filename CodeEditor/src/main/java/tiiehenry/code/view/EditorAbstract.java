...
public abstract class EditorAbstract extends ViewGroup implements Document.TextFieldMetrics {
    ...
    protected static SparseArray<String> PICKER_SETS = new SparseArray<>();
    ...
    public EditorAbstract(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public EditorAbstract(Context context, AttributeSet attrs, int defStyle) {
